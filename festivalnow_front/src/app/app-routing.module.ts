...
const routes: Routes = [
  ...
  {path: 'PSE', component: PseComponent, canActivate:[AuthGuard], data: { roles: ['CLIENT','ADMIN'] }},
  {path: 'login',component: LoginComponent},
  {path: 'recover',component: RecoverPasswordComponent},
  {path: 'register',component:RegisterComponent},
  {path: 'setting', component:SettingComponent, canActivate:[AuthGuard],  data: { roles: ['ADMIN'] }},
  {path: 'edit',component:EditUserComponent, canActivate:[AuthGuard], data: { roles: ['ADMIN','HOST'] }},
  {path: 'profile',component:ProfileComponent, canActivate:[AuthGuard], data: { roles: ['CLIENT', 'ADMIN', 'HOST', 'EMPLOYEE'] }},
  ...
  {path: 'hostEvent',component:HostEventComponent,canActivate:[AuthGuard], data: { roles: ['HOST','ADMIN'] }},
  {path: 'customize',component:CustomizeComponent, canActivate:[AuthGuard], data: { roles: ['HOST','ADMIN'] }},
